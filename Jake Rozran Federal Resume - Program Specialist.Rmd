...
**Location:** 3527 Mt. Diablo Blvd., Unit 269, Lafayette, CA  
...
- For the Centers of Medicare and Medicaid (CMS), leveraging Natural Language 
Processing (NLP) in the creation and evaluation of System Security Plans (SSPs) 
to optimize the Authority to Operate (ATO) process; analyzing AWS usage to 
forecast annual usage and identify inefficiencies; using graph analysis and NLP 
to identify related documents to provide enhanced search capabilities.
- One of five members of the company's Diversity, Equity, Inclusion, and 
Accessibility (DEIA) team; responsible for helping improve the company's DEIA 
practices, including analyzing demographic data, designing surveys to understand 
company feeling about DEIA, and identifying and improving company policy to be 
more inclusive.
