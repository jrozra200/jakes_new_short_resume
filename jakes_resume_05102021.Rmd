...
tribble(
        ...
        "Project Manager", "Comcast: Messaging Application Eng (MAE)", "Philadelphia, PA", "2013-2014", "Served as a PM & ScrumMaster for the MAE team.",
        "Implementation Manager", "Booz Allen Hamilton", "Rockville, MD", "2010-2013", "Served as the Implementation Manager for several web applications.",
