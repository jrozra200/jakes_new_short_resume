...
tribble(
        ...
        "Data Science Practice Lead", "CivicActions", "San Fransico, CA", "2021-Pres.", "Starting a Data Science Practice Area at CivicActions; spend time working on data solutions, sales, marketing, and project management.",
        "Solutions Consultant", "Socure", "New York, NY", "2020-2021", "Technical expert on fraud prevention, Know Your Customer (KYC)/Customer Identification Program (CIP), Socure product modules, data science, statistics, data visualization, and proof of concept presentations in support of the sales and onboarding processes.",
